...
public:
	...
	bool Voronoi_non_Contrain_from_tet(vector<int>* p_trifacelist, vector<int>* p_tetrahedronlist, vector<int>* p_neighborlist);
...
/*
  ...
  */  
    ...
    bool Voronoi_Contrain_TetGen(int Type_Appel,char* Arg_Tet,long ind_group_tet,bool erase_tet_out, char* bin_path=NULL);
...
*/
    ...
    int Calcul_Interpolation_Noeud_Esclave(vector<long>* P_List_Ind_Noeud_FoFo,vector<double>* P_List_FoFo,
		                                   vector<long>* P_List_Ind_Noeud_Esclave_Front = NULL, vector<long>* P_List_Ind_Noeud_Esclave_Internal = NULL);

    void Calcul_Interpolation_Noeud_Esclave_Front(vector<long>* P_List_Ind_Noeud_Esclave_Front,vector<long>* P_List_Ind_Noeud_FoFo,vector<double>* P_List_FoFo);
	void Calcul_Interpolation_Noeud_Esclave_Internal(vector<long>* P_List_Ind_Noeud_Internal, vector<long>* P_List_Ind_Noeud_FoFo, vector<double>* P_List_FoFo){}

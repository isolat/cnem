...
interpol=py_cnem3d.interpol(XYZ_Noeud,IN_Tri_Ini)
#interpol=py_cnem3d.interpol(XYZ_Noeud,[])

#-------------------------------------------------------------------------------
# creat dummy point location for interpolation evaluation

XYZ_Point=list((np.random.random(1000*3)-0.5)*0.15)
Type_FF=0

interpol.set_point(XYZ_Point,Type_FF)
